<template>
  <div class="row">
   <div class="col-lg-12">
      <div class="card">
         <div class="card-header" style="background-color:rgba(0,0,0,.03)">Processing Order Lists</div>
             ...
             <table class="table table-responsive-sm table-bordered table-striped table-hover table-sm">
                ...
                <tbody>
                   ...
                   <tr  v-for="order in orders"  :key="order.id">
                      ...
                      <td>{{order.total}}</td>
                      <td><span class="badge badge-success" v-if="order.status == 2">Processing</span></td>
                      <td>
         ...
         <div class="card-footer" style="background-color:rgba(0,0,0,.03)">
           ...
           <nav class="float-left ml-4 mt-1">
             <p>Showing {{fromq}} - {{toq}} from {{totalq}} Processing orders </p>
           </nav>
...
export default {
  data () {
    return {
      breadcrumb: [
          {name: 'Home',link: '/'},
          {name: 'Processing Order List',link: ''},
      ],
