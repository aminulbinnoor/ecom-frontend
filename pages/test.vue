...
<div class="card">
<div class="card-header"> Collapse <router-link to="/">Home</router-link>
<div class="card-header-actions"><a class="card-header-action" href="https://coreui.io/docs/components/bootstrap-collapse/" target="_blank"><small class="text-muted">docs</small></a></div>
</div>
<div class="card-body">
