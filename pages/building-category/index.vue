   ...
   <div class="col-lg-12">
      <div class="card">
         <div class="card-header" style="background-color:rgba(0,0,0,.03)">
          <p class="float-left">Building Category List</p>
          <router-link to="/building-category/create" type="button" name="button" class="float-right btn btn-info"> Add New Building Category </router-link>
         </div>
            ...
            <table class="table table-responsive-sm table-bordered table-striped table-hover table-sm">
               ...
               <tbody>
                  <tr v-for="building in buildings"  :key="building.id">
                     ...
                     <td>
                       <router-link :to="`/building-category/${building.id}/edit`" type="button" name="button" class="btn btn-info btn-sm">Edit</router-link>
         ...
         <div class="card-footer" style="background-color:rgba(0,0,0,.03)">
           ...
           <nav class="float-left ml-4 mt-1">
             <p>Showing {{fromq}} - {{toq}} from {{totalq}} Building Category </p>
           </nav>
...
export default {
  data () {
    return {
      breadcrumb: [
          {name: 'Home',link: '/'},
          {name: 'Building Category List',link: ''},
      ],
  ...
  methods: {
    ...
    TheDelete(id){
      http1.post('/building-category/delete',{
          id: id,
      }).then((response)=>{
