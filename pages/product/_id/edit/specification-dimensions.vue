   ...
   <div class="col-lg-12">
      <div class="card">
         <div class="card-header" style="background-color:rgba(0,0,0,.03)">
          <p class="float-left">Product Specification Dimensions</p>
         </div>
...
export default {
  data () {
    return {
      breadcrumb: [
          ...
          {name: 'Product Specification Dimensions', link: ''},
      ],
      variations: [],
    }
  },
  ...
  methods: {
    submit() {
      http1.post('/product/set-specification-dimensions',{
    ...
    addNew(){
      this.variations.push({name: '',value: ''})
    },
    removeNew(i){
  ...
  mounted: function () {
    http1.get('/product/get-specification-dimensions',{
      params:{
        id: this.$route.params.id
      }
    }).then((response)=>{
