  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
       <div class="card" style="min-height:250px">
         <div class="card-header" style="background-color:rgba(0,0,0,.03)">Theme Filter</div>
         <div class="card-body">
             <div class="form-row">
   ...
   <div class="col-lg-12">
      <div class="card" style="min-height:400px;">
         <div class="card-header" style="background-color:rgba(0,0,0,.03)">
          <p class="float-left">Theme List</p>
          <router-link to="/theme/create" type="button" name="button" class="float-right btn btn-info"> Add New Theme </router-link>
         </div>
            ...
            <table class="table table-responsive-sm table-bordered table-striped table-hover table-sm">
               ...
               <tbody>
                  ...
                  <tr  v-for="theme in themes"  :key="theme.id">
                     ...
                     <td>
                       <span v-if="theme.is_active == 1" class="badge badge-success">Active</span>
                       <span v-else class="badge badge-danger">Inactive</span>
                     </td>
                     <td>
                       <router-link :to="`/theme/${theme.id}/edit`" type="button" name="button" class="btn btn-info btn-sm">Edit</router-link>
                       <button type="button" class="btn btn-danger btn-sm" @click="TheDelete(theme.id)">Delete</button>
                     </td>
                  </tr>
               </tbody>
            </table>
         ...
         <div class="card-footer" style="background-color:rgba(0,0,0,.03)">
           ...
           <nav class="float-left ml-4 mt-1">
             <p>Showing {{fromq}} - {{toq}} from {{totalq}} Theme </p>
           </nav>
  ...
  methods: {
    getData() {
      http1.get('theme/get',{
        ...
        this.themes = response.data.data.data
