    ...
    <div class="row">
       <div class="col-sm-12 col-md-12 col-lg-12">
          <div class="card" style="min-height:250px">
            <div class="card-header" style="background-color: rgb(0,0,0,.03);">Brand Partner Entry</div>
            <div class="card-body">
                <div class="form-row">
                  ...
                  <div class="col-md-12 mt-2">
                      ...
                      <ImageUpload :title="``" :perpose="'bpartner'"  :limit="1" @image="storeImage" ></ImageUpload>
                  </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    submit() {
      ...
      http1.post('/brand-partner/create',formData).then((res)=>{
