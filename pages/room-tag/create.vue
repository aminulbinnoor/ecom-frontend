    ...
    <div class="row">
       <div class="col-sm-12 col-md-12 col-lg-12">
          <div class="card" style="min-height:250px">
            <div class="card-header" style="background-color:rgba(0,0,0,.03)">Room Tag Entry</div>
            <div class="card-body">
                <div class="form-row">
...
export default {
  ...
  methods: {
    submit() {
      if(this.name == ''){
          this.$toast.error('Room Tag name is required',{duration:3000})
          return
      }else if (this.status == '') {
      ...
      http1.post('/room-tag/create',formData).then((response)=>{
